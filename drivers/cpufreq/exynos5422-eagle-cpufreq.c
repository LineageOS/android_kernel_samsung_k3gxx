					 ...
					 unsigned int new_index)
{
	...
	sec_debug_aux_log(SEC_DEBUG_AUXLOG_CPU_BUS_CLOCK_CHANGE,
		"[A15] %7d <= %7d",
		exynos5422_freq_table_CA15[new_index].frequency, exynos5422_freq_table_CA15[old_index].frequency);
...
#endif
	info->boot_cpu_min_qos = exynos5422_freq_table_CA15[lv_idx].frequency;
	info->boot_cpu_max_qos = exynos5422_freq_table_CA15[lv_idx].frequency;
}
#endif
...
int __init exynos5_cpufreq_CA15_init(struct exynos_dvfs_info *info)
{
	...
	__raw_writel(0x0, EXYNOS5422_ARMCLK_STOPCTRL);
