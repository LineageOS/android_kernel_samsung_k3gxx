					 ...
					 unsigned int new_index)
{
	...
	sec_debug_aux_log(SEC_DEBUG_AUXLOG_CPU_BUS_CLOCK_CHANGE,
		"[A07] %7d <= %7d",
		exynos5422_freq_table_CA7[new_index].frequency, exynos5422_freq_table_CA7[old_index].frequency);
...
#endif
	info->boot_cpu_min_qos = exynos5422_freq_table_CA7[lv_idx].frequency;
	info->boot_cpu_max_qos = exynos5422_freq_table_CA7[lv_idx].frequency;
}
#endif
